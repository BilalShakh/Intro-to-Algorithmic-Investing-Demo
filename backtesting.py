...
class BackTest:
    ...
    def sellStock(self, date, price, buyCost):
        ...
        self.tradeRes.append(round(gain, 3))
    ...
    def getResults(self):
        ...
        print("This strategy has a winrate of "+ str(winRate) + "% by placing " + str(numTrades) + " trades and earned an average return of " + str(round(avgReturn,2)) + "%.")
